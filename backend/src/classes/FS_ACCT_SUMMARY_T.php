...
class FS_ACCT_SUMMARY_T {
    ...
    public static function get_all($offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.FS_ACCT_SUMMARY_T';
    ...
    public static function get_all_by_account_nbr($nbr, $offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.FS_ACCT_SUMMARY_T WHERE ACCOUNT_NBR = :p1';
