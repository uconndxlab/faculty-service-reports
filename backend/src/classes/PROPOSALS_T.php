...
class PROPOSALS_T {
    ...
    public static function get_all($offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.PROPOSALS_T';
    ...
    public static function get_all_by_projid($nbr, $offset = 0, $limit = 100) {
        $db = Database::create();
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.PROPOSALS_T WHERE PROJID = :p1';
