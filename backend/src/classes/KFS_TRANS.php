...
class KFS_TRANS {
    ...
    public static function get_all($offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.KFS_TRANS';
    ...
    public static function get_all_by_account_nbr($nbr, $offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.KFS_TRANS WHERE ACCOUNT_NBR = :p1';
    ...
    public static function get_all_by_account_fincode($nbr, $fincode, $offset = 0, $limit = 100) {
        ...
        $statement = 'SELECT * FROM FIN_REPORTING.KFS_TRANS WHERE ACCOUNT_NBR = :p1 AND FIN_OBJECT_CD = :p2';
